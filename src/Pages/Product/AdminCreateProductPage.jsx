...
import { createProduct } from '../../Redux/ActionCreaters/ProductActionCreaters'
                                ...
                                <form onSubmit={postData}>
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 mb-3">
                                            ...
                                            <input type="number" name="basePrice" onChange={getInputData} className={`form-control border-2 ${showError && errorMessage.basePrice ? 'border-danger' : 'border-primary'}`} placeholder='Product Base Price' />
                                        ...
                                        <div className="col-lg-6 mb-3">
                                            ...
                                            <input type="number" name="discount" onChange={getInputData} className={`form-control border-2 ${showError && errorMessage.discount ? 'border-danger' : 'border-primary'}`} placeholder='Product Base Price' />
                                        ...
                                        <div className="col-12 mb-3">
                                            ...
                                            <div className={`border ${showError && errorMessage.color ? 'border-danger' : 'border-primary'} rounded`}>
                                        ...
                                        <div className="col-12 mb-3">
                                            ...
                                            <div className={`border ${showError && errorMessage.size ? 'border-danger' : 'border-primary'} rounded`}>
                                                <div className="row p-2">
                                                    <div className="col-12 mb-3">
                                                        <label className='ps-2'>Measurement<span className='text-danger'>*</span></label>
                                                        <input type="text" className="form-control border-primary" placeholder="S,M,L,XL OR 20ml,50ml OR 2kg,5kg"
                                                            onChange={(e) => {
                                                                ...
                                                                setData({ ...data, size: arr })
                                                                setErrorMessage({ ...errorMessage, size: arr.length ? "" : "Size field is Mendatory" })
                                                            }}
                                                        />
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-lg-4 mb-3">
                                            ...
                                            <input type="number" name="stockQuantity" onChange={getInputData} className={`form-control border-2 ${showError && errorMessage.stockQuantity ? 'border-danger' : 'border-primary'}`} placeholder='Product Base Price' />
